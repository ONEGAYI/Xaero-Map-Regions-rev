...
public final class RegionKeyMappings {
    ...
    private static final IKeyConflictContext XAERO_MAP_CONTEXT = new IKeyConflictContext() {
        ...
        public boolean conflicts(IKeyConflictContext other) {
            return other == XAERO_MAP_CONTEXT || other == XAERO_EDIT_MODE_CONTEXT;
        }
    };
    private static final IKeyConflictContext XAERO_EDIT_MODE_CONTEXT = new IKeyConflictContext() {
        @Override
        public boolean isActive() {
            return XaeroScreenDetector.isWorldMapScreen(Minecraft.getInstance().screen)
                    && XaeroMapOverlayController.session().isEditing();
        }
    ...
    public static final Lazy<KeyMapping> SUBMIT_DRAFT = Lazy.of(() -> new KeyMapping(
            ...
            XAERO_EDIT_MODE_CONTEXT,
            InputConstants.Type.KEYSYM,
            GLFW.GLFW_KEY_ENTER,
            CATEGORY
    ));

    public static final Lazy<KeyMapping> UNDO_DRAFT_POINT = Lazy.of(() -> new KeyMapping(
            "key.xaeroregionsrev.undo_draft_point",
            XAERO_EDIT_MODE_CONTEXT,
            KeyModifier.CONTROL,
            InputConstants.Type.KEYSYM,
            GLFW.GLFW_KEY_Z,
    ...
    public static final Lazy<KeyMapping> REDO_DRAFT_POINT = Lazy.of(() -> new KeyMapping(
            "key.xaeroregionsrev.redo_draft_point",
            XAERO_EDIT_MODE_CONTEXT,
            KeyModifier.CONTROL,
            InputConstants.Type.KEYSYM,
            GLFW.GLFW_KEY_Y,
    ...
    public static void register(RegisterKeyMappingsEvent event) {
        ...
        event.register(UNDO_DRAFT_POINT.get());
        event.register(REDO_DRAFT_POINT.get());
